  ...
  return (
    <div className="min-h-screen bg-surface flex items-center justify-center p-6">
      <div className="text-center">
        ...
        <h1 className="text-2xl font-semibold text-text-default mt-4">
          Page not found
        </h1>
        ...
        <div className="flex items-center justify-center gap-3 mt-8">
          <button
            onClick={() => navigate(-1)}
            className="flex items-center gap-2 px-5 py-2.5 border border-border text-text-default rounded-xl hover:bg-primary/10 transition-all"
          >
            <ArrowLeft size={18} />
            Back
          </button>
