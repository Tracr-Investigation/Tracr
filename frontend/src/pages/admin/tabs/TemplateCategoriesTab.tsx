            ...
            <div className="mb-8 flex items-center justify-between">
                <div className="bg-gradient-to-r from-primary to-secondary rounded-xl p-6 inline-flex items-center gap-4">
                    <div className="w-12 h-12 bg-input-bg rounded-lg flex items-center justify-center">
                        <Layers size={24} className="text-text-default"/>
                    </div>
                    <div>
                        <p className="text-text-muted text-sm">{t('admin.templateCategories.totalLabel')}</p>
                        <p className="text-text-default text-3xl font-bold">{categories.length}</p>
                    </div>
                </div>
