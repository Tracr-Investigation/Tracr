      ...
      <div className="text-xs text-text-dim mt-auto pt-2 flex items-center justify-between gap-2">
        ...
        {canDelete && (
          <button
            ...
            className="p-1 text-text-dim hover:text-red-400 transition-colors opacity-0 group-hover:opacity-100"
            title="Supprimer"
          >
            <Trash2 size={12} />
          </button>
  ...
  return (
    <>
      ...
      >
        ...
        {/* Body — no overflow so the template dropdown can expand freely */}
...
export const DocumentsTab = ({ investigationId, investigationTitle, userPermission }: Props) => {
  ...
  return (
    <div className="border-t border-border-subtle pt-6">
      ...
      {/* Always mounted for smooth slide transition */}
      <CreateDocumentPanel
