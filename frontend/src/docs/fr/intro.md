...
| Sources | Captures et archives de pages web avec empreinte SHA-256, texte extrait (OCR) |
| Sélecteurs | Surveillance d'identifiants (e-mail, pseudo…) dans le texte des sources, avec détection des occurrences (hits) |
...
| Sécurité du compte | Authentification à deux facteurs (2FA/TOTP) et phrase de récupération BIP39 (12 mots) |
...
| **Super-administrateur** | Contrôle total de la plateforme, dont les mises à jour de l'application |
